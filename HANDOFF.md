...
- `Dockerfile` and `docker-compose.yml` exist but have never been built or run; the Docker engine was not running on this machine on 2026-09-14 (G2.2.4). No deployment pipeline, readiness probe, request logging or error tracking exists (G2.3 to G2.6).
